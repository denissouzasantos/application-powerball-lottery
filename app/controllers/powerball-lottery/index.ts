...
import { validateBody } from "./input-validation";
import { calculateWinningTikets } from "./calculate-winning-tickets";
...
const getPickWithWinnings = (pick: UserPick, draw: Draw): ResPick => {
  ...
  const winnings = calculateWinningTikets(matchCount, doesPowerballMatch);
